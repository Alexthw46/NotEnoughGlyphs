...
public class FilterLivingNotPlayer extends FilterLiving {
    public static final FilterLivingNotPlayer INSTANCE = new FilterLivingNotPlayer("filter_living_not_player", "Filter: Not Player");

    public FilterLivingNotPlayer(String tag, String description) {
